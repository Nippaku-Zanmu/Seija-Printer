...
//                Rotations.rotate(SeijaUtil.getYaw(hitPos), SeijaUtil.getPitch(hitPos), 50, clientSide,
//                    () ->
...
//
//
//                        Rotations.rotate(SeijaUtil.getYaw(testHitPos), SeijaUtil.getPitch(testHitPos), 50, clientSide,
//                            () ->
...
////        } else {
////            neighbour = blockPos.offset(direction.getOpposite());
////            //hitPos.add(new Vec3d(direction.getOpposite().getUnitVector()).multiply(0.5));
////            hitPos.add(direction.getOffsetX() * 0.5, direction.getOffsetY() * 0.5, direction.getOffsetZ() * 0.5);
////        }
////
////
...
////
////        if (mc.player.getEyePos().y < pos.getY())
////            list.add(Direction.DOWN);
////        if (mc.player.getEyePos().y > pos.getY() + 1)
////            list.add(Direction.UP);
////        if (mc.player.getX() < pos.getX())
...
////
////
////    public static List<Direction> getHelpBlockFac(BlockPos pos, boolean strictFac, List<Direction> ignoreFac) {
////        //ignoreFac用于在1t内放置多个方块 Pos offset ignorefac=首先放置的方块
////        List<Direction> list = canTorchFac(pos);
////        List<Direction> canUseFac = new ArrayList<>();//posOffset这个fac为点击的方块 发包时需要反转
////
////        for (Direction facing : Direction.values()) {
////            if (strictFac && list.contains(facing)) {
////                continue;
////            }
////            //if ((ignoreFac != null && ignoreFac.contains(facing)))
////            canUseFac.add(facing);
////        }
////        //if (ignoreFac!=null)
////        // canUseFac.addAll(ignoreFac);
////        return canUseFac;
////    }
////
////    public static Direction getPlaceSide(BlockPos blockPos, Direction requiredDir, boolean strictFac, boolean ignoreFac) {
////        Direction[] values = strictFac ? getHelpBlockFac(blockPos, true, null).toArray(new Direction[0]) : Direction.values();
////
