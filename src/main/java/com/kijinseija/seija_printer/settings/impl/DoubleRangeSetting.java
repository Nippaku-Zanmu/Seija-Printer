...
public class DoubleRangeSetting extends Setting<DoubleRange> {
    ...
    public static class Builder extends SettingBuilder<Builder, DoubleRange, DoubleRangeSetting> {
        ...
        public DoubleRangeSetting build() {
            return new DoubleRangeSetting(name, description, defaultValue, onChanged, onModuleActivated, visible, min, max, Math.max(sliderMin, min), Math.min(sliderMax, max), onSliderRelease, decimalPlaces, noSlider);
        }
    }
}
