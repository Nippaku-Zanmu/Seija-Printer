...
public class PosSorter {
    ...
    private static int sortAngle(BlockPos pos1, BlockPos pos2) {
        ...
        double e1pitch = Math.abs(SeijaUtil.getPitch(pos1.toCenterPos()) - mc.player.getPitch());
        double e2pitch = Math.abs(SeijaUtil.getPitch(pos2.toCenterPos()) - mc.player.getPitch());
